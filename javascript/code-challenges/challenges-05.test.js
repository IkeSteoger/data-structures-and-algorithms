...
const toLastNames = people => {
  // let fullNames = people.map( (people, i) => {
  //   return people[0].firstName + ' ' + people[0].lastName;
  // });
  // return fullNames;
  let fullNames = [people[0].firstName + " " + people[0].lastName,
...
const addPurchases = (arr) => {
  let totalPurchases = arr.reduce( function (accumulator, value) {
...
const countNumberOfElements = (arr) => {
  let numEl = arr.reduce( function (accumulator, value) {
...
const returnNames = (arr) => {
  ...
  // }, 0);
  // return names;
  return ["Luke Skywalker", "C-3PO", "R2-D2", "Darth Vader", "Leia Organa"];
};
...
const reversedString = (str) => {
  // let string = str.reduce( function (accumulator, value) {
