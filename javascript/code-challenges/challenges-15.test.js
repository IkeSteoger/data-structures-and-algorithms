...
const detectTicTacToeWin = (board) => {
  function helpCheck(row1, col1, row2, col2, row3, col3){
    if(row1.includes(col1, col2, col3), row2.includes(col1, col2, col3), row3.includes(col1, col2, col3)){
      return true;
    } else {
      return false;
    }
  }
  return helpCheck(board[0], board[0][0], board[1], board[1][1], board[2], board[2][2]);
};
